...
public class Audio extends JPanel implements ActionListener, ControlContext {
    ...
    public Audio(String audioDirectory, Effects effetti) {
		...
		spetrometro = new Spetrometro("Audio");
		...
		animazione = new Immagine(nomifile,"Immagine non trovata",116,62);
    ...
    public void saveToFile(File file, Sound audio, AudioFileFormat.Type fileType) {
        ...
        if (audio == null) {
            reportStatus("Non c'è nulla da salvare.");
            return;
        }
    ...
    public class Playback implements Runnable {
        ...
        public void run() {
            ...
            if (audioWavStream == null) {
                shutDown("Non è stato caricato nessun file audio per la riproduzione.");
                return;
            }
            ...
            // e si assicura la compatibilità.
    ...
    /**
     * Esegue il playback dello stream audio sul quale è stao applicato l'effetto
     */
