...
public class Normalizer extends Filter {
	...
	/*
	 * @see Filter#setParameter(int, double)
	 */
	...
	/*
	 * @see Filter#setParameter(int, Object)
	 */
	...
	/*
	 * @see Filter#getParameterAsObject(int)
	 */
