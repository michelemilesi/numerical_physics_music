...
import com.github.michelemilesi.university.music.ControlContext;
...
public class Effects extends JScrollPane implements ControlContext, Runnable {
	...
	public Effects() {
		...
		InputStream configResource = ClassLoader.getSystemResourceAsStream("effetti.ini");
		if (configResource != null) {
			setup = new BufferedReader(new InputStreamReader(configResource));
		} else {
	...
	} // end com.github.michelemilesi.university.music.Effects()
