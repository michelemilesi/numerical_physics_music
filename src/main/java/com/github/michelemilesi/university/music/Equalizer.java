 ...
 * com.github.michelemilesi.university.music.Equalizer.java
 *
...
public class Equalizer extends FrequencyFilter {
    public final static int FREQUENCIES = FrequencyFilter.OVERLAP + 1;
    public final static int DB_VALUES = FrequencyFilter.OVERLAP + 2;
    
    private double[] freqs;
    private double[] dBs;
    
    /** Creates new com.github.michelemilesi.university.music.Equalizer */
    public Equalizer() {
        freqs = new double[0];
        dBs = new double[0];
    }
    ...
    protected Spectrum[] process(Spectrum[] spectre, double rate) {
        ...
        return result;
    }//end process(com.github.michelemilesi.university.music.Spectrum[], double)
