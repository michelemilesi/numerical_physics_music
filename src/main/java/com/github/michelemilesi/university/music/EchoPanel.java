...
public class EchoPanel extends AbsPanel implements ActionListener, ChangeListener {
	...
	public void loadFilter(String description, String nome_filtro) throws Exception {
		try {
			...
			System.out.println("Errore di caricamento/istanziazione filtro: com.github.michelemilesi.university.music.Echo");
			throw e;
		}
	}
...
}  // end com.github.michelemilesi.university.music.Echo
